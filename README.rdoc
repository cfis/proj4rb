...
=== Crs
Next, create a coordinate system. To create a coordinate system, you can use CRS codes, well-known text (WKT) strings
...
expose this object via Context.current and store it using thread local storage. Use the context object to
access error codes, set proj4 compatability settings, set the logging level and to install custom logging code.
