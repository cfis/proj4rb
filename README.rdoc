...
=== Examples
The proj4b test suite hsa example of calling every API method! More tutorial like examples can be found in the examples folder and include:

* Convert between a CRS and geodetic coordinates for that CRS (from Proj quick start guide)
...
Proj versions 5 and higher are *very* different than Proj version 4. Changes are documented at
